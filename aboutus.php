...
<html>
  ...
  <body>
    ...
    <button onclick="topFunction()" id="myBtn" title="Go to top" value="UP">
    </button>
...
?>
    ...
    <div class="wide">
        <div class="col-xs-2 logo center rounded"><img src="images/logo.png"></div>
        ...
        <h3 style="color: red">About the food culture in Cafe Wow</h3>
        <br>
